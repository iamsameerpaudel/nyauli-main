...
const HeroSection = () => {
  return (
    <section id="hero" className="relative max-h-screen pt-16 sm:pt-20 overflow-hidden gradient-hero">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 ">
        ...
        <div className="lg:hidden flex flex-col items-center justify-around min-h-[calc(100vh-25rem)] py-10 space-y-8">
          ...
          >
            ...
            <p className="text-md sm:text-base lg:text-lg text-muted-foreground mb-4 sm:mb-8">
          ...
          >
            ...
            <Button size="xl" className="group w-full translate-y-7 sm:w-auto" asChild>
              <Link to="/pricing">
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-foreground text-base">100+ Orders</p>
                  <p className="text-xs text-muted-foreground">Processed today</p>
                </div>
              </div>
            </motion.div>
